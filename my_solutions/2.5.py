...
class RideData(Sequence):
    ...
    def __getitem__(self, index):
        if isinstance(index, slice):
            ...
            # Handle single integer index - return as dictionary
            return Row(self.routes[index], self.dates[index], self.daytypes[index], self.numrides[index])

    def append(self, d : Row):
